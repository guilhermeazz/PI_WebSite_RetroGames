    ...
    <div className="min-h-screen bg-white text-black p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {jogos.map((jogo) => (
          <div
            key={jogo.id_produto}
            className="flex flex-col bg-white p-4 rounded-lg shadow-lg border border-gray-200 cursor-pointer transition-transform transform hover:scale-105 hover:shadow-xl"
